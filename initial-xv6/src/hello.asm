  ...
  15:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  39:	6a 01                	push   $0x1
  3b:	e8 d0 03 00 00       	call   410 <printf>
        exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 594:	eb 1a                	jmp    5b0 <printf+0x1a0>
          s = "(null)";
 596:	bb a8 07 00 00       	mov    $0x7a8,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 67d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 680:	8b 3d 58 0a 00 00    	mov    0xa58,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6f2:	e8 e9 fe ff ff       	call   5e0 <free>
  return freep;
 6f7:	a1 58 0a 00 00       	mov    0xa58,%eax
 ...
 724:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 727:	a3 58 0a 00 00       	mov    %eax,0xa58
}
